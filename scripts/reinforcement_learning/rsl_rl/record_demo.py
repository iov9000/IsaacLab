...
parser.add_argument(
    ...
    type=int,
    default=None,
    help="Total number of demo steps to record",
)
...
def main():
    ...
    while timestep < args_cli.total_demo_steps:
    ...
    demo_data_path = os.path.join(
        log_dir,
        f"{args_cli.task}_{args_cli.total_demo_steps}_demo_data.pkl",
    )
    print(f"[INFO] Saving demo data to {demo_data_path}")

    pickle.dump(demo_data, open(demo_data_path, "wb"))
